...
$APPLICATION->SetTitle("Аренда строительного оборудования и инструмента в России | Объявления на доске kargo24.su");
            ...
            <div class="row">
                ...
                <?$APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "DISPLAY_TOP_PAGER" => "N",
                        "ELEMENT_SORT_FIELD" => "property_DATE_SORT",
                        ...
                        "SECTION_TOP_DEPTH" => "1",
                        "SEF_FOLDER" => "/arenda-stroitelnogo-oborudovaniya/",
                        "SEF_MODE" => "Y",
                        "SET_LAST_MODIFIED" => "N",
                        "SET_STATUS_404" => "N",
                        "SET_TITLE" => "Y",
