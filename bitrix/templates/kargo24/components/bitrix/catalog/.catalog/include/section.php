...
if((int)$arSectionDepth['DEPTH_LEVEL'] == 2
    ...
    CModule::IncludeModule('highloadblock');
        ...
        $arrFilter = array("=PROPERTY_TYPE" => $res['UF_XML_ID']);
        $FilterUrl = 'filter/type-is-' . mb_strtolower($res['UF_XML_ID']) . '/apply/';
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "PROPERTY_TYPE_VALUE" => $res['UF_NAME'],
